        ...
        <div class="menu">
            ...
            <ul class="lista derecha ocultar-desde-medianos">
                ...
                <li><a class="dropdown-toggle efecto-borde-rojo izquierda"
                        data-target="#versiones">v2.0.0</a></li>
                <a href="https://github.com/FedericoManzano/BodyStyle-v2.0.0-compilado/archive/master.zip" class="btn fd-naranja ">Descargar</a>
            </ul>
        </div>
    ...
    <section id="cabecera-principal" itemscope itemtype="http://schema.org/CreativeWork">
        <span class="badge-md badge-rojo" itemprop="version">v 2.0.0</span>
    ...
    <section itemscope itemtype="http://schema.org/CreativeWork" class="secciones">
        ...
        <div class="fila" itemprop="description">
            ...
            <div class="cs-12 cm-6 cl-4  mab-10">
                ...
                <p class="parrafo">
                    Todas las versiones de la librería están en repositoros de GitHub los cuales están 
            ...
            <div class="cs-12 cm-6 cl-4  mab-10">
                ...
                <p class="parrafo">
                    ...
                    preoporcionado por Ruby y que es de descarga libre desde la página oficial.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="secciones" itemscope itemtype="http://schema.org/CreativeWork">
        <h2 itemprop="name" class="fz-s-42"><span class="icon-bullhorn c-azul-c">&nbsp</span>v2.0.0</h2>
        <div class="fila" itemprop="description">
            ...
            <div class="cs-12 cm-6  p-1  mab-10">
                ...
                <p class="parrafo">
                    ...
                    pudiendo acceder a ellos a través de un archivo global con todas las variables
    ...
    <section class="secciones" itemscope itemtype="http://schema.org/CreativeWork">
        ...
        <div class="d-flex just-centrada">
            <div class="a-i">
                <h6 class="mar-3 fz-20"><span class="icon-file-zip c-naranja">&nbsp</span>BodyStyle-v2.0.0.zip</h6>

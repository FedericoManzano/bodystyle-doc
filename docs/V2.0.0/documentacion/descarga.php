    ...
    <article id="descarga" class="article scroll-item">
        ...
        <div class="fila mab-0">
            <div class="cs-12 cm-6">
                ...
                <a href="https://github.com/FedericoManzano/BodyStyle-v2.0.0-compilado/archive/master.zip" class="btn fd-azul-ve">Descargar</a>
            </div>
            <div class="cs-12 cm-6">
                <h3>Código Fuente</h3>
                <p class="parrafo">
                ...
                <a href="https://github.com/FedericoManzano/bodystyle-fuente-v2.0.0/archive/master.zip" class="btn fd-azul-ve">Descargar</a>
            </div>
        </div>
    ...
    <article id="cdn" class="article scroll-item">
        ...
        <div class="html">
            <pre class="brush:html">
                <link rel="stylesheet" href="https://ghcdn.rawgit.org/FedericoManzano/bodystyle-fuente-v2.0.0/master/dist/css/bodystyle.min.css">
            </pre>
        </div>
        ...
        <div class="html">
            <pre class="brush:html">
                <script src="https://ghcdn.rawgit.org/FedericoManzano/bodystyle-fuente-v2.0.0/master/dist/js/bodystyle.min.js"></script>
            </pre>
        </div>
        <h3>Jquery</h3>
        <p class="parrafo">

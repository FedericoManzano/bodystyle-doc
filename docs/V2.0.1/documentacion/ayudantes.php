...
<section class="contenido-pagina">
    ...
    <article id="ejemplo" class="article scroll-item">
        <h2>Ejemplo</h2>
        <p>
            Vamos a mostrar un ejemplo que es aplicable a todas las clases antes definidas.
            Vamos a mostrar un elemento sólo en dispositivos grandes donde la medida de la pantalla 
            es superior a 1024px.
        </p>
        <div class="ejemplo">
            <div class="ej-100 mostar-solo-grandes"></div>
        </div>
        <div class="html">
            <pre class="brush:html">
                <!-- Este elemento solo va a ser visible en dispositivos grandes (l)-->
                <div class="ej-100 mostar-solo-grandes"></div>
            </pre>
        </div>
    </article>

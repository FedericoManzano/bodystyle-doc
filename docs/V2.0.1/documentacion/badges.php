...
<section class="contenido-pagina">
    ...
    <?php 
        $titulo = "Badges";
        $descripcion = "Elementos que permiten mostrar información en espacios 
    ...
    <article id="muestra" class="article scroll-item">
        ...
        <p>
            Badges tipo etiqueta de varios colores. Utilizando los pseudoelementos after y 
            before para generar el triángulo en la parte lateral.
        </p>
        <div class="ejemplo">
    ...
    <article id="like" class="article scroll-item">
        <h2>Botón Like</h2>
        <p>
            Un botón muy útil cuando trabajamos con artículos evaluados por los usuarios.
        </p>
        <div class="ejemplo">

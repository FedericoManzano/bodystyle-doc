...
<section class="contenido-pagina">
    ...
    <article id="responsive" class="article scroll-item">
        <h2>Flexbox responsive <span class="badge badge-verde">Nuevo</span></h2>
        <p>
            En la librería disponemos de las clases antes mencionadas a lo largo 
            de esta sección pero individualizadas para cada tamaño de pantalla. 
            En muchas ocaciones queremos aplicar determinados estilos en un tamaño de 
            pantalla pero en otros no. Es importante que las clases de Flexbox cuenten con esta propiedad 
            para realizar diseños mas adaptables.
        </p>
        <h3>Ejemplo Flex Wrap Responsive</h3>
        <p>
            En este ejemplo vamos a ver como la propiedad flex wrap puede ser útil 
            para una mejor adaptación del los elementos. 
        </p>

        <div class="alerta-op-gris">
            Lo que vamos a hacer es que una fila de flexbox de botones varie el ancho de los elementos 
            hasta dispositivos chicos (funcionamiento normal) y a partir del tamaños extra pequeños (xs) vamos 
            a agregar la clase flex-wrap-xs aclarando el prefijo del disposivo menores a 400 px de ancho.
        </div>
        ...
        <p>
            En disposivos mayores a 400px los elementos van a disminuir su ancho de manera tal 
            que se mantengan alineados en una sola fila de flexbox. A partir de disposivos menores 
            400 px el ancho de los elementos no varia por lo tanto se crean nuevas filas para distribuir 
            los elementos.
        </p>
        <div class="html">
            <pre class="brush:html">
        ...
        <p>
            Todas las clases poseen esta propiedad de adaptabilidad. 
            Las funcionalidades son las mismas pero se agrega el parámetro 
            del tamaño de pantalla al cual hace referencia.
        </p>
    </article>

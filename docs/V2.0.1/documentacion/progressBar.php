...
<section class="contenido-pagina">
    ...
    <?php 
        $titulo = "Progress Bar";
        $descripcion="un elemento que mejora la experiencia de usuario y permite ver 
        el avance de las peticiones en pantalla. cuando se realiza un consulta a través de ajax, la página 
        actual no se actualiza, simplemente espera los datos correspondientes a la petición. En estos casos 
        es útil mostrarle al usuario el pregreso de la petición y no mantenerlo esperando sin saber que es lo que 
        ocurrió.";
